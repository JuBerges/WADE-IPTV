...
while selected_channel is None:
    ...
    for i, channel in enumerate(channels):
        ...
        pygame.draw.rect(window, WHITE, (button_x, button_y, button_w, button_h))
...
if vlc_path  != None:
    ...
    #os.system('"{}" "{}"'.format(vlc_path, selected_channel["url"]))
    #os.startfile("C:/Program Files/VideoLAN/VLC/vlc.exe", selected_channel["url"])
#pygame.mixer.init()
#pygame.mixer.music.load()
#pygame.mixer.music.play()

    # Créer un nouvel objet VLC
    #instance = vlc.Instance()

    # Créer un nouveau lecteur
    #player = instance.media_player_new()

    # Créer un nouveau média à partir du lien M3U8
    #media = instance.media_new(selected_channel["url"])

    # Charger le média dans le lecteur
